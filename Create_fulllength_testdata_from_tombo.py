...
# //////// select the folder where the processed fasta5 file from Tombo are located and the save path ///////////

main_folder = "/main_folder" # folder where the single_fast5 is saved
folders_list = os.listdir(main_folder)

path = os.getcwd()
save_path = path + "/saving_path" #saving path
...
# ///////// here start the preprocessin part to create data for the PseudoDeC analysis /////////

for i in range (0,len(multi_fast5_files)):
